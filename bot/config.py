...
HELIUS_MAX_MONITORED_ADDRESSES: int = int(
    os.getenv("HELIUS_MAX_MONITORED_ADDRESSES", "100000")
)
ALERT_WORKER_POLL_SECONDS: float = float(os.getenv("ALERT_WORKER_POLL_SECONDS", "1"))
TOKEN_ACCOUNT_REFRESH_SECONDS: float = float(
    os.getenv("TOKEN_ACCOUNT_REFRESH_SECONDS", "900")
)
...
for setting_name, setting_value in {
    ...
    "HELIUS_MAX_MONITORED_ADDRESSES": HELIUS_MAX_MONITORED_ADDRESSES,
    "ALERT_WORKER_POLL_SECONDS": ALERT_WORKER_POLL_SECONDS,
    "TOKEN_ACCOUNT_REFRESH_SECONDS": TOKEN_ACCOUNT_REFRESH_SECONDS,
