...
- `HELIUS_MAX_PAYLOAD_BYTES`, `HELIUS_MAX_MONITORED_ADDRESSES`,
  `ALERT_WORKER_POLL_SECONDS`, `TOKEN_ACCOUNT_REFRESH_SECONDS`,
...
HELIUS_MAX_MONITORED_ADDRESSES=100000
ALERT_WORKER_POLL_SECONDS=1
TOKEN_ACCOUNT_REFRESH_SECONDS=900
